...
function construirSystemPrompt({ nombreBot, nombreEstudio, horariosOcupados, scoreInfo, umbral, contextoPortal = null, archivosRecientes = null, carpetasCausas = null }) {
...
${carpetasCausas.slice(0, 50).join(', ')}${carpetasCausas.length > 50 ? ` ... y ${carpetasCausas.length - 50} más.` : ''}

Usa esta lista para responder: ¿existe la causa X?, ¿cuántas causas hay?, ¿hay alguna causa de [apellido]?` : ''}
` : '';
