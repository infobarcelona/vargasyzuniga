...
Para obtener información real usa estas APIs (son internas y seguras):
- Archivos recientes: GET https://vargasyzuniga.onrender.com/api/drive/recientes
- Contenido de documento: GET https://vargasyzuniga.onrender.com/api/drive/contenido/{fileId}
- Lista de causas: GET https://vargasyzuniga.onrender.com/api/drive/carpetas

Cuando pregunten sobre archivos o causas, llama a la API correspondiente y responde con datos reales.
` : '';
