...
Esta persona YA está verificada — NO pidas verificación adicional de identidad, NO pidas confirmar usuario.
Tienes datos reales del sistema más abajo. Úsalos directamente para responder sin rodeos.
Trátala por su primer nombre con familiaridad profesional.
...
${contenidoArchivo ? `CONTENIDO DEL ARCHIVO "${contenidoArchivo.nombre}" (texto extraído en tiempo real):
