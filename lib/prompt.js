...
function construirSystemPrompt({ nombreBot, nombreEstudio, horariosOcupados, scoreInfo, umbral, contextoPortal = null, archivosRecientes = null }) {
...
Usa estos datos para responder preguntas sobre archivos recientes. Si preguntan por el contenido de un archivo específico, indica su ID para que el abogado pueda buscarlo.` : 'No se pudieron obtener archivos recientes en este momento.'}
` : '';
