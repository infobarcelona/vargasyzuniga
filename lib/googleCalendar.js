...
function getAuth() {
  ...
  console.log('[CALENDAR DEBUG] clientId:', clientId ? 'OK' : 'FALTA');
  console.log('[CALENDAR DEBUG] clientSecret:', clientSecret ? 'OK' : 'FALTA');
  console.log('[CALENDAR DEBUG] refreshToken:', refreshToken ? 'OK' : 'FALTA');
  if (!clientId || !clientSecret || !refreshToken) {
    throw new Error('Faltan variables de entorno para Google Calendar OAuth2');
  }
